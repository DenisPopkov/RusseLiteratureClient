package ru.popkov.russeliterature.features.library.data.repositories

import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map
import kotlinx.coroutines.runBlocking
import kotlinx.coroutines.withTimeout
import ru.popkov.russeliterature.features.library.data.local.daos.ArtistDao
import ru.popkov.russeliterature.features.library.data.local.daos.SongDao
import ru.popkov.russeliterature.features.library.data.local.mappers.ArtistMapper.toDomain
import ru.popkov.russeliterature.features.library.data.remote.api.SongsApi
import ru.popkov.russeliterature.features.library.data.remote.mappers.ArtistMapper.toEntity
import ru.popkov.russeliterature.features.library.data.remote.mappers.SongMapper.toEntity
import ru.popkov.russeliterature.features.library.domain.model.Artist
import ru.popkov.russeliterature.features.library.domain.model.Song
import ru.popkov.russeliterature.features.library.domain.repositories.SongRepository
